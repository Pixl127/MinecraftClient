...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   protected static String[] decompose(String path, char seperator) {
      String[] astring = new String[]{"minecraft", path};
      int i = path.indexOf(seperator);
      if (i >= 0) {
         astring[1] = path.substring(i + 1);
         if (i >= 1) {
            astring[0] = path.substring(0, i);
         }
      }
