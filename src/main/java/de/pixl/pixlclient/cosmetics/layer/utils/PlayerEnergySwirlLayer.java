package de.pixl.pixlclient.cosmetics.layer.utils;
...
public abstract class PlayerEnergySwirlLayer<T extends Player, M extends PlayerModel<T>> extends RenderLayer<T, M> {
    public PlayerEnergySwirlLayer(RenderLayerParent<T, M> p_116967_) {
        super(p_116967_);
    }
